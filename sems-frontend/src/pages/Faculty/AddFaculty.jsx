    ...
    return (
        <div className="d-flex">
            ...
            <div className="flex-grow-1" style={{ backgroundColor: 'var(--background-color)', minHeight: '100vh', maxHeight: '100vh', overflowY: 'auto' }}>
                <Navbar title="Add Faculty" />
                <div className="p-4 d-flex justify-content-center">
                    <div className="dashboard-card w-100" style={{ maxWidth: '800px' }}>
                        <h4 className="mb-4 text-primary">Create New Faculty Member</h4>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row g-3 mb-3">
                                ...
                                <div className="col-md-4">
                                    ...
                                    <input type="text" name="designation" className="form-control" required value={formData.designation} onChange={handleChange} placeholder="e.g. Professor" />
                                </div>
                            </div>
